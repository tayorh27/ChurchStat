...
public class TourActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] dt = data.getAdminDetails();
        if(dt[1].isEmpty()) {
            data.setAdminDetails("admin", "admin");
        }
    ...
    private void launchHomeScreen() {
        ...
        ratingses.add(new Ratings(0, "", "", "", "", "no_date"));
        MyApplication.getWritableRatings().insertRating(ratingses, false);
